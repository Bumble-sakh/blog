                ...
                <div class="card-body">
                    <form method="POST" action="#">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ $post_name }}" required autofocus placeholder="Название поста">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="text" rows="5" class="form-control" name="text" required placeholder="Текст поста">{{ $text }}</textarea>
                            </div>
                        </div>
